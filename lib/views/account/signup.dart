...
class _SignupPageState extends State<SignupPage> {
  ...
  FocusNode _invateTextBoxFocus = FocusNode();
  ...
  static bool isChinaPhoneLegal(String str) {
    ...
    _isTrue =
        new RegExp('^((13[0-9])|(15[^4])|(166)|(17[0-8])|(18[0-9])|(19[8-9])|(147,145))\\d{8}\$')
            .hasMatch(str);
    return _isTrue;
  }
  ...
  _getValidateCode() async {
    var result = await AccountRequest.validateCode({"phone": _userName, "business": "SIGNUP"});
    print(result);
  }
  ...
  _signup() async {
    if (_signupForm.currentState.validate()) {
      ...
      var result = await AccountRequest.signup({
        "phone": _userName,
