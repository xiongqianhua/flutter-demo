...
class HashratePage extends StatefulWidget {
  final category;

  HashratePage({Key key, this.category}) : super(key: key);

  @override
  _HashratePageState createState() => _HashratePageState();
}

class _HashratePageState extends State<HashratePage> {
  List _hashrateData = [];
  dynamic result;
